...
public class DoodleView extends View {
    ...
    public DoodleView(Context context, AttributeSet attrs) {
        ...
        // set the initial display setting for the painted line
        paintLine = new Paint();
    ...
    // called whe the user touches the screen
    ...
    // called whe the user finishes a touch
    ...
    public void saveImage() {
        ...
        if ( location != null ) {
            // display a message indicating that the image was sved
